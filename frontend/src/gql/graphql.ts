...
export type MessagesByRoomQueryVariables = Exact<{ [key: string]: never; }>;


export type MessagesByRoomQuery = { __typename?: 'Query', messagesConnectionByRoom: { __typename?: 'MessageConnection', totalCount: number, edges: Array<{ __typename?: 'MessageEdge', cursor: string, node: (
