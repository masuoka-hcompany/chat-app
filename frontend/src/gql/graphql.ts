...
export type MessageItemFragmentFragment = { __typename?: 'Message', id: string, contents: string, sender: { __typename?: 'User', id: string, profile?: { __typename?: 'Profile', name: string, profileImageUrl?: string | null } | null } } & { ' $fragmentName'?: 'MessageItemFragmentFragment' };
